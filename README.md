...
<!-- <section class="hero">
  <div class="hero-text">
    ...
    <p style="font-size:17px;opacity:0.7;color:#7e22ce;margin-top:8px;">
      100% College Focused • Real Company Patterns • No Distractions • Results Oriented
    </p>
    <p style="font-size:15px;opacity:0.6;color:#475569;margin-top:12px;">
      ⏱ Timed Practice & Strategy  |  🏆 Self-Challenge  |  🎯 Faster Placement Success
    </p>
  </div>
</section> -->
...
<section class="daily-tests">
  ...
  <div class="test-grid">
    <div class="test-card">
      ...
      <div class="info">⏱ 1 Question per minute strategy</div>
    ...
    <div class="test-card">
      ...
      <div class="info">Solve within</div>
      <div class="time">25 Minutes</div>
      <div class="info">🧠 Improve logic + decision making</div>
    ...
    <div class="test-card">
      ...
      <div class="info">✍ Accuracy in grammar & comprehension</div>
    ...
    <div class="test-card">
      ...
      <div class="info">Solve within</div>
      <div class="time">20 Minutes</div>
      <div class="info">🎯 Prepare answers before interviews</div>
...
<section class="company-tests">
  ...
  <div class="test-grid">
    <div class="test-card">
      <h3>TCS (National Qualifier Test – NQT)</h3>
      <div class="time">25 Questions</div>
      <div class="info">Solve within</div>
      <div class="time">25 Minutes</div>
      <div class="info">⏱ 1 Question per minute strategy</div>
...
<div class="right-circle-buttons">
  <a href="login.html" class="circle-btn login-circle">🔑</a>
  <a href="https://wa.me/919441982385" target="_blank" class="circle-btn whatsapp-circle">💬</a>
</div>
